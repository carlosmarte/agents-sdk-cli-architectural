...
import { DEFAULT_MODEL, PROVIDER_ID, createOpenAIKit } from "../src/index.js";
...
describe("usecase-kit-adapter-openai", () => {
  it("targets the openai provider and default model", () => {
    const { orch } = fakeOrchestrator();
    const kit = createOpenAIKit({ orchestrator: orch });
