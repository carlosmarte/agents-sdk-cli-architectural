...
import { DEFAULT_MODEL, PROVIDER_ID, createCopilotKit } from "../src/index.js";
...
describe("usecase-kit-adapter-copilot", () => {
  it("targets the copilot provider and default model", () => {
    const { orch } = fakeOrchestrator();
    const kit = createCopilotKit({ orchestrator: orch });
