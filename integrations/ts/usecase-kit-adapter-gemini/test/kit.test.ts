...
import { DEFAULT_MODEL, PROVIDER_ID, createGeminiKit } from "../src/index.js";
...
describe("usecase-kit-adapter-gemini", () => {
  it("targets the gemini provider and default model", () => {
    const { orch } = fakeOrchestrator();
    const kit = createGeminiKit({ orchestrator: orch });
