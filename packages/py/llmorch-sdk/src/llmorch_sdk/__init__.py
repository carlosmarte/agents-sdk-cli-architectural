...
Importing this package triggers the side-effect import of every provider
adapter, each of which self-registers via `@register(...)` at module load. The
...
import llmorch_adapter_local  # noqa: F401
